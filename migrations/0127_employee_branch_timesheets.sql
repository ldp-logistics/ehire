-- ============================================================
-- 0127: Employee branch backfill for timesheets / region scope
--
-- Timesheets filter by employee effective region (branch + location).
-- Employees with branch_id NULL are invisible to regional admins.
-- Idempotent: same rules as 0126 — safe to re-run
-- ============================================================
